...
public class AccountView extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
		...
		center.setTopAnchor(label3, 130.0);
		center.setLeftAnchor(label3, 10.0);
		...
		center.setTopAnchor(txtName2, 150.0);
		center.setLeftAnchor(txtName2, 10.0);
		...
		center.getChildren().addAll(label,label1,okbutton,txtName, txtName2, account,label3,txtName3);
